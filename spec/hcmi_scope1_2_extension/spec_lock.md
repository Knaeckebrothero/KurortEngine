...
**Anchored by:** the pool-3 tier-1 triage review §11 binding contract (5 AC EARS verbatim)
...
- Pool-3 tier-1 triage review §11 — binding contract (5 ACs)
- HCMI Scope 1+2 extension — spec-input synthesis
- HCMI Scope 1+2 RED test conventions (5 AC, EARS verbatim) — red-input synthesis
