...
```
cd34c4a494cab0293fb9cebe0030d7af10cd7350e1e180132a74438610b2755a  spec/avv_kaskade/spec.yaml
```

**Verification command:** `shasum -a 256 spec/avv_kaskade/spec.yaml`
must return `cd34c4a494cab0293fb9cebe0030d7af10cd7350e1e180132a74438610b2755a`.
...
shasum -a 256 spec/avv_kaskade/spec.yaml
# Expected: cd34c4a494cab0293fb9cebe0030d7af10cd7350e1e180132a74438610b2755a
...
Consult the lawyer-budget-gate state-of-project record
