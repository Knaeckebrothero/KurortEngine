...
- Design-note search query used before drafting: `Kurort Exception Radar Meldeschein Kurtaxe remittance Rechnung retention audit compliance cockpit duplicate failed dead-end Hotel Rheinland UI`.
