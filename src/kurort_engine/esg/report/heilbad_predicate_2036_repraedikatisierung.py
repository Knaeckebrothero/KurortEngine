...
disclosure footer per Subagent-B KEPT-2 forced-flaw mitigation), this module's
...
.. [SHA-HCMI] Sustainable Hospitality Alliance (SHA) HCMI methodology —
   ...
   per Subagent-B KEPT-2 forced-flaw mitigation; https://hmii.global/).
...
#: Canonical 6 Kurort-vertical anchors per spec.yaml §12 + KB note A-5.
...
#: RED-1 verbatim non-affirmation clause (per Subagent-B KEPT-1 forced-flaw
...
#: RED-2 SHA methodology citation (per Subagent-B KEPT-2 forced-flaw
#: mitigation). Embedded verbatim in the AC-5 disclosure footer; the AC-5
#: test_oracle asserts substring coverage of this exact string.
