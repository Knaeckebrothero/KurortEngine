...
.. [SHA-HCMI] Sustainable Hospitality Alliance (SHA) HCMI methodology —
   ...
   the module docstring per the design review KEPT-2 forced-flaw mitigation;
   https://hmii.global/).
...
#: certified-green electricity contracts (0.02 kg CO2e/kWh). Per the design review
...
#: 2026 grid (0.42 kg CO2e/kWh). Per the design review KEPT-2 forced-flaw mitigation,
...
def calculate_scope_2(
    ...
    emission factors (per the design review KEPT-2 forced-flaw mitigation):
    ...
    # Per the design review KEPT-2 forced-flaw mitigation: green_contract=True MUST
