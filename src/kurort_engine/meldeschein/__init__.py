...
Meldeschein (registration form) layer per the DE-Kurort-vertical
design spec (12-day burn, 9 modules).
...
# MeldescheinForm(form) public API, per the spa_wellness phase-7 lesson
# (@dataclass(frozen=True, init=False) pattern for custom constructors).
# ---------------------------------------------------------------------------
