...
cross-sell tickets) per the Critic verdict KB note
``verdict-iteration-2-choose-loop-16-proposal-001-spawellness-resource-management-``
§6.4 acceptance criteria AC-1..AC-8.
